let posts = [
  {
    ...
    text: [
      "Just a week after returning from Colombia, a close friend called and asked if I wanted to move to China with him. Even though I basically hadn’t even unpacked, I told him I was down. His sister had gone to China years before with a non-profit group called <a href=“https://ilp.org”>ILP</a> and recommended the experience. We applied to the program and were accepted to the same city to teach English at a boarding school called QingYing Foreign Language School in Changzhou. Changzhou lies about halfway between Shanghai and Nanjing, meaning it’s about halfway up the coast and a couple hours inland. We met between classes at the University to open the email where it said we would go, spent a minute looking at things in the city, then went to class. We were very excited.",
